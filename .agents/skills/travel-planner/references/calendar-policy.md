...
- אחרי כתיבה דרך מחבר Google Calendar יש לבדוק גם את התיאור שהוחזר מהכתיבה.
  המחבר עשוי לעטוף טקסט עם שורות ריקות בתגיות `<p>` אף שהקלט היה plain text.
- אם התיאור שהוחזר כולל HTML, יש לפתוח את האירוע בממשק העריכה של Google
  Calendar, לבחור את כל שדה התיאור, להפעיל `הסרת העיצוב` ולשמור.
- באירוע עם משתתפים, השמירה אינה מושלמת עד שמטפלים בחלון
  `רוצה לשלוח עדכונים באימייל`. יש לבחור `בלי לשלוח` כברירת מחדל, אלא אם
  המשתמש ביקש במפורש לשלוח עדכון.
- לאחר השמירה יש לפתוח מחדש את האירוע ולוודא ששדה התיאור אינו מכיל עוד
  פסקאות HTML. קריאה רגילה דרך המחבר אינה מספיקה לאימות, משום שהיא עשויה
  להחזיר טקסט מנורמל ולהסתיר את התגיות השמורות.
...
10. אחרי כתיבה דרך המחבר, להריץ את בדיקת ה־HTML ואת רצף
    `הסרת העיצוב`/`בלי לשלוח` שמתואר בסעיף הפורמט הטכני.
...
9. אחרי השמירה, לפתוח מחדש את האירוע ולאמת שהתגיות אכן הוסרו; באירוע עם
   משתתפים יש להשלים את חלון `בלי לשלוח` כדי שהשינוי לא יתבטל.
