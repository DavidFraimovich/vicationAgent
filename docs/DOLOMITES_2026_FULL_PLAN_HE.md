...
>
> גרסת מקור: `plan-a-2026-09-05-v25` | המסמך עודכן: **05.09.2026**
...
| 11.9 | Venice, VCE, Target Rent, Noventa di Piave, בסיס מזרחי | Rialto, צהריים ב־VCE, איסוף רכב ב־13:30, אאוטלט, סופרמרקט ונסיעה מאוחרת | ✅ הרכב והלינה מאושרים; התקבלו הוראות self check-in וחניה |
...
| 22:35–22:55 | הגעה ו־late check-in | כניסה עצמאית מאושרת. אוספים מפתח מהתיבה בכניסה למשרד Larese, ואז מגיעים לכניסה האחורית של הדירה. חניה בחצר תוך השארת מקום לרכבים אחרים; הרחוב הוא גיבוי. |
