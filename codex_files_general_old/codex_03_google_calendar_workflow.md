...
- **Lago di Braies / Pragser Wildsee** — ליצור כאירוע Plan A מפורט של 4–5 שעות: להגיע מוקדם בבוקר, חניה קרובה לאגם אם זמינה/מוזמנת, סירת עץ לכ־2 שעות לפי מחיר עבודה 50€, מסלול מעגלי סביב האגם שמתוכנן לשעתיים למרות שבפועל כשעה, תמונות וקפה/נשנוש. לציין שהאגם עצמו פתוח 24/7, אך חובה לבדוק סמוך לטיול זמינות/מחיר סירות, חניה והגבלות גישה.
...
6. להוסיף fallback.
7. לא ליצור אירוע Conditional אם אין החלטה שמתאימה לאותו יום.
...
7. אם האירוע נהיה לא מתאים — לסמן כ־Optional או להחליף, לא למחוק בלי אישור.
